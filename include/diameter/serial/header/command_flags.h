#ifndef DIAMETER_SERIAL_HEADER_COMMAND_FLAGS_H
#define DIAMETER_SERIAL_HEADER_COMMAND_FLAGS_H
...
template <typename OutputIt,
          typename T,
          diameter::message::is_diameter_message_header_command_flags<T>* dummy = nullptr>
